...
import { convertSketchStyle, exportForensicReport } from '../lib/api';
...
export default function RightPanel({ generateResult = null, editResult = null, prompt = '' }: RightPanelProps) {
